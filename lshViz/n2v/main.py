...
def learn_embeddings(walks, dim, window, iter):
    """
	Learn embeddings by optimizing the Skipgram objective using SGD.
	"""
    walks = [list(map(str, walk)) for walk in walks]
    print("about to train embeddings")
    model = Word2Vec(
        walks,
        size=dim,
        window=window,
    ...
    print("produced node2vec embeddings")
...
def main(args):
    ...
    G = node2vec.Graph(nx_G, args.directed, 0.7, 0.3)
